...
public class b {
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        C0027b c0027b = new C0027b(i3, new byte[(i2 * 3) / 4]);
        if (!c0027b.a(bArr, i, i2, true)) {
            throw new IllegalArgumentException("bad base-64");
        }
        if (c0027b.a == c0027b.b.length) {
            return c0027b.b;
        }
        byte[] bArr2 = new byte[c0027b.a];
        System.arraycopy(c0027b.b, 0, bArr2, 0, c0027b.a);
        return bArr2;
    }
