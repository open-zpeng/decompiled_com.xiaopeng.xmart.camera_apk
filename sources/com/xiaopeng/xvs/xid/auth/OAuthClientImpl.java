...
public final class OAuthClientImpl extends IClient implements IOAuth {
    ...
    public void requestOAuth(final Activity activity, final ICallback<String, IException> iCallback, Handler handler) {
        ...
        this.mContextWrapper.getAuthToken(account, IOAuth.AUTH_TYPE_AUTH_CODE, new ICallback<String, IException>() { // from class: com.xiaopeng.xvs.xid.auth.OAuthClientImpl.1
    ...
    public IResponse requestOAuth(Activity activity) {
        ...
        return this.mContextWrapper.getAuthToken(account, IOAuth.AUTH_TYPE_AUTH_CODE);
    }
    ...
    public void requestOTP(ICallback<String, IException> iCallback, Handler handler) {
        ...
        if (account == null) {
            ...
            this.mContextWrapper.getAuthToken(account, IOAuth.AUTH_TYPE_AUTH_OTP, iCallback, handler);
        }
    }
    ...
    public IResponse requestOTP() {
        ...
        return this.mContextWrapper.getAuthToken(XId.getAccountApi().getAccount(), IOAuth.AUTH_TYPE_AUTH_OTP);
    }
