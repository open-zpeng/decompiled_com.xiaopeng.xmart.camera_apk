...
class CarSettingsSyncImpl implements ICarSettingsSync {
    ...
    @Override // com.xiaopeng.xvs.xid.sync.api.ICarSettingsSync
    public String getKeyPlayContent(String str) {
        return this.mWrapper.get(ICarSettingsSync.KEY_PLAY_CONTENT, str);
    }

    @Override // com.xiaopeng.xvs.xid.sync.api.ICarSettingsSync
    public void setKeyPlayContent(String str) {
        this.mWrapper.put(ICarSettingsSync.KEY_PLAY_CONTENT, str);
    }
