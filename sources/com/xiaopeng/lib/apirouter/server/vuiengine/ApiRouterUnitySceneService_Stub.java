...
public class ApiRouterUnitySceneService_Stub extends Binder implements IInterface {
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        if (i == 0) {
            ...
            try {
                this.provider.onVuiQuery((String) TransactTranslator.read(uri3.getQueryParameter("event"), "java.lang.String"), (String) TransactTranslator.read(uri3.getQueryParameter(CacheEntity.DATA), "java.lang.String"));
                parcel2.writeNoException();
                TransactTranslator.reply(parcel2, null);
                return true;
            } catch (Exception e3) {
