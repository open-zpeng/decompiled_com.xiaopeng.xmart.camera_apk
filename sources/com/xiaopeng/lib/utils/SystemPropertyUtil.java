...
public class SystemPropertyUtil {
    ...
    public static void setAiosWakeUpEnable(boolean z) {
        SystemProperties.set(SYSTEM_PROPERTY_AIOS_WAKEUP, z ? "1" : ISpeechContants.SCREEN_ID_MAIN);
    }
    ...
    public static void setInCall(boolean z) {
        SystemProperties.set(SYSTEM_PROPERTY_CALLING, z ? "1" : ISpeechContants.SCREEN_ID_MAIN);
    }
    ...
    public static int getConfigCode() {
        return SystemProperties.getInt("persist.sys.xiaopeng.configCode", 0);
    }
